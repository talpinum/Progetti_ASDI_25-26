...
entity unita_controllo is 
	port( 
		  ...
		  selAQ, subtract, stop_cu: out std_logic); --, stop_cu
end unita_controllo;


architecture structural of unita_controllo is
	type state is (idle, acquisisci_op, wait_sr, avvia_scan, avvia_shift, incr_count, fine); --,wait_start_release
	signal current_state,next_state: state;

	begin 
	
	-- ciò rappresenta la memoria
	...
	-- rappresenta la logica combinatoria		  
