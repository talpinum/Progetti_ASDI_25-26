...
entity unita_operativa is
	port( X, Y: in std_logic_vector(7 downto 0);--moltiplicatore e moltiplicando
		  ...
		  loadAQ, shift, loadM, sub, selAQ, count_in: in std_logic; -- selF,  selM,
...
architecture structural of unita_operativa is
	...
	port( clock,  reset: in std_logic; --, reset_count 
...
begin
	...
	-- 6) contatore
	CONT: cont_mod8 port map(clock, reset, count_in, count); -- reset_count
